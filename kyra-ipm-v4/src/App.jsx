...
import ProveedorDetalle from './pages/ProveedorDetallePage'
import ServicioDetalle from './pages/ServicioDetallePage'
                ...
                <main id="main-content" className="main-content" tabIndex="-1">
                  <FacturacionProvider>
                    <Routes>
                      ...
                      <Route path="/administracion/proveedor/:id" element={<ProveedorDetalle />} />
                      <Route path="/administracion/servicio/:id" element={<ServicioDetalle />} />
